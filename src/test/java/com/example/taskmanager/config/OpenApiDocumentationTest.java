...
class OpenApiDocumentationTest {
    ...
    @Test
    void documentacao_openapi_publica_expoe_metadados_e_esquema_bearer() throws Exception {
    ...
    @Test
    void documentacao_openapi_separa_operacoes_publicas_das_protegidas() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                .andExpect(status().isOk())
    ...
    @Test
    void documentacao_openapi_expoe_respostas_de_erro_do_contrato() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                .andExpect(status().isOk())
